  ...
  return {
    ...
    skills: [
      ...
      },
      {
        ...
        outputModes: ["application/json"],
        endpoints: [
          { method: "GET", path: "/bootstrap", description: "Step-by-step zero-capital bootstrap guide" },
          { method: "GET", path: "/use-cases", description: "Concrete examples of agents using credit advances" },
          { method: "GET", path: "/fees", description: "Current fee model and example rates" },
          { method: "GET", path: "/auth/info", description: "How to authenticate (EIP-191 wallet signature)" },
