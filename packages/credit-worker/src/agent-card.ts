    ...
    skills: [
      ...
      },
      {
        ...
        endpoints: [
          ...
          { method: "GET", path: "/chains", description: "List all active chains with deployed contracts" },
          { method: "GET", path: "/chain/:chainId/health", description: "Chain-specific contract status" },
          { method: "GET", path: "/chain/:chainId/credit-check/:address", description: "Read credit score on any chain" },
        ],
      },
    ],
