...
const riskColor: Record<RiskReport['overallRisk'], string> = {
  ...
  return (
    <Card title="Portfolio Health">
      <div className="space-y-4">
        ...
        <div className="h-2 bg-border-bright" role="progressbar" aria-valuenow={pct} aria-valuemin={0} aria-valuemax={100}>
